            ...
            <div class="portlet-body">
                <form role="form" method="POST" action="{{route('roadmap.update')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6 col-md-offset-3">
                        ...
                        <input data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-width="100%" type="checkbox" value="1" name="roadmap_sec" {{ $frontend->roadmap_sec == 1 ? 'checked' : '' }}>
                    </div>
                    <div class="form-group">
