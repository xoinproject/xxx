            ...
            <div class="portlet-body">
                <form role="form" method="POST" action="{{route('banner.update')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        <label for="ban_title" style="font-size: 20px;">Banner Title</label>
                        <input type="text" value="{{$frontend->ban_title}}" name="ban_title" class="form-control">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="ban_subtitle" style="font-size: 20px;">Banner Sub-Title</label>
                        <input type="text" value="{{$frontend->ban_subtitle}}" name="ban_subtitle" class="form-control">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="ban_price" style="font-size: 20px;">Unsold Token</label>
                        <input type="text" value="{{$frontend->ban_price}}" name="ban_price" class="form-control">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="ban_sold" style="font-size: 20px;">Sold Token</label>
                    ...
                    <div class="row">
                     <div class="form-group col-md-6">
                        <label style="font-size: 20px;">Countdown Section Visibility</label>
                        <input data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-width="100%" type="checkbox" value="1" name="banner_sec" {{ $frontend->banner_sec == 1 ? 'checked' : '' }}>
                    </div>
                    <div class="form-group col-md-6">
                        <label style="font-size: 20px;">Search Section Visibility</label>
                        <input data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-width="100%" type="checkbox" value="1" name="search_sec" {{ $frontend->search_sec == 1 ? 'checked' : '' }}>
                    </div>
                    </div>
                    <div class="form-group">
                        <hr/>
